<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="text-center">
                        <h1 class="text-3xl font-bold mb-4">Selamat Datang di Sistem Informasi Rekam Refraksi</h1>
                        
                        <div class="my-4 text-center"> <!-- Menambahkan class text-center untuk memusatkan gambar -->
                            <img src="{{ url('images/optometris3.jpg') }}" alt="Optometrist Image" class="size-auto mx-auto" style="max-height: 400px;"> 
                            <div class="text-center"> <!-- Menambahkan div untuk memusatkan tombol -->
                                <a href="{{ route('ukurans.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-600 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue disabled:opacity-25 transition ease-in-out duration-150">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /> <!-- Mengganti SVG untuk menghilangkan angka 1 -->
                                    </svg> <!-- Menghilangkan angka 1 -->
                                    Mulai Refraksi
    ...
    <footer class="bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-4 dark:bg-gray-800 antialiased">
        <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
            &copy; 2024-Ver 1.0 | <a href="https://wa.me/628157141460" class="hover:underline" target="_blank">Asep Abdul Rojak. A.Md.RO-Optometrist</a>. All rights reserved.
        </p>
